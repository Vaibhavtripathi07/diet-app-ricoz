...
let item ={name,email,phoneNumber,password,User}

console.log(item)

let result = await fetch ("https://lazy-cyan-springbok-slip.cyclic.app/api/v1/signup",{
  method: "POST",
  headers:{
...
//opposite replace login component with signup and viceversa
  <div className="relative min-h-screen flex font-sans">
  <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 bg-white">
    <div className="sm:w-1/2 sm:py-11 xl:w-1/2 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative">

      <div className="absolute bg-[rgb(239,253,226)] inset-0 z-0"></div>
      <div className="w-full  max-w-md z-10 shadow-none">
        <div className="sm:text-4xl -my-24 xl:text-5xl font-bold leading-tight mb-6">
          <img src={Logo} alt="" />
        </div>
    ...
    <div className="md:flex md:items-center md:justify-center   w-full sm:w-auto md:h-full  xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white">
      <div className="max-w-md w-full space-y-5 -my-10 ">
        <div className="text-center">
          <h2 className="mt-2 text-3xl font-bold text-gray-900">
            Welcome !
          </h2>
          <p className="mt-0 text-17xl  text-black font-sans font-semibold">Create your Account</p>
        </div>

        <div class="flex flex-row justify-center items-center space-x-3 ">
            <a href="https://www.behance.net/" target="_blank"
              class="w-11 h-11 items-center justify-center inline-flex rounded-2xl text-black font-bold text-lg  bg-dark-green-color hover:shadow-lg cursor-pointer transition ease-in duration-300"><img
                className="w-4 h-4"
            ...
            <a href="https://twitter.com/" target="_blank"
              class="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg  text-white bg-dark-green-color hover:shadow-lg cursor-pointer transition ease-in duration-300"><img
                className="w-4 h-4"
            ...
            <a href="https://in.linkedin.com/" target="_blank"
              class="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg   text-white bg-dark-green-color hover:shadow-lg bg-blend-color-dodge cursor-pointer transition ease-in duration-300"><img
        ...
        <form className=" space-y-0" >
          <div>
          <label htmlFor="Name" className="ml-3 font-bold text-black text-5xl">Name</label>
          <input type="text" name="name" value={name} onChange={(e)=>setUserName(e.target.value)} className="w-full text-base px-4 py-2 border border-solid border-grey-color rounded-lg outline-none  focus:border-[#CFF7AA]"
          ...
          <div className="relative">
            ...
            <input
              ...
              name="email" value={email} onChange={(e)=>setEmail(e.target.value)}    type="email" placeholder="mail@gmail.com"  />
          </div>
          <div className="mt-8 content-center">
              <label htmlFor="password" className="ml-3 text-5xl font-bold text-gray-700 ">Phone No.</label>
              <input
                className="w-full content-center text-base px-4 py-2 no-number-spin border border-solid border-grey-color rounded-lg  outline-none focus:border-[#CFF7AA]"
                type="Number" placeholder="1234567890"   value={phoneNumber}
          ...
          <div className="mt-8 content-center">
            ...
            <input
              ...
              name="password" value={password} onChange={(e)=>setPassword(e.target.value)} type="password" placeholder="Enter your password" />
          </div>
          <div className="mt-8 content-center">
            <label htmlFor="Account" className="ml-3 text-5xl font-bold text-gray-700 "  type="Accounttype"></label>
            <input
                className="w-full content-center text-base px-4  py-2 no-number-spin border border-solid border-grey-color rounded-lg  outline-none focus:border-[#CFF7AA]"
                type="text" value={Accounttype}
                onChange={(e)=>setAccounttype(e.target.value)}  name="Accounttype"/>
          </div>
          ...
          <div>
            <button
              ...
              className="w-full flex justify-center mt-10 [background:linear-gradient(93.37deg,_rgba(175,_228,_126,_0.4),_rgba(216,_250,_185,_0.4))] border border-solid border-[#CFF7A] text-dark-green-color p-4 text-5xl  rounded-2xl tracking-wide font-semibold  cursor-pointer transition ease-in duration-500"
            >
              Sign Up
            </button>
          </div>
          <p className="flex  items-center justify-center mt-10 text-center text-md text-gray-500">
            ...
            <a href="/" className="text-dark-green-color hover:text-lime-600  font-semibold cursor-pointer transition ease-in duration-300">Log in</a>
          </p>
        </form>
      </div>
    </div>
...
//     let item = { username, email, phoneNumber, password };
//     // console.log(item)
...
//         <div>
//           <label htmlFor="Name" className="ml-3 font-bold text-black text-5xl">
//             Name
//           </label>
//           <input
//             type="text"
...
//         </div>
//         <div className="relative">
//           <label htmlFor="email" className="ml-3 font-bold text-black text-5xl">
//             Email-ID
//           </label>
//           <input
//             className="w-full text-base px-4 py-2 border border-solid border-grey-color rounded-lg outline-none  focus:border-[#CFF7AA]"
...
//         </div>
//         <div className="mt-8 content-center">
//           <label htmlFor="password" className="ml-3 text-5xl font-bold text-gray-700">
//             Phone No.
//           </label>
//           <input
//             className="w-full content-center text-base px-4 py-2 no-number-spin border border-solid border-grey-color rounded-lg  outline-none focus:border-[#CFF7AA]"
...
//         <p className="flex items-center justify-center mt-10 text-center text-md text-gray-500">
//           <span>Already have an account?</span>
//           <a href="/" className="text-dark-green-color hover:text-lime-600  font-semibold cursor-pointer transition ease-in duration-300">
//             Log in
//           </a>
//         </p>
//       </form>
