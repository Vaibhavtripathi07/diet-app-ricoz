...
const Join = () => {
  return (
    <section className="absolute">
      <section className="absolute top-[4964px] left-[100px] w-[1350px] h-[897px]">
        <section className="absolute top-[0px] left-[293px] w-[726px] h-[100px]">
          <section className="absolute top-[0px] left-[362.18px] rounded-sm bg-beige w-[363.82px] h-[100px]" />
          <section className="absolute top-[0px] left-[0px] rounded-sm bg-whitesmoke w-[363.82px] h-[100px]" />
        </section>
        <h1
        ...
        <section className="absolute top-[720px] left-[calc(50%_-_565px)] w-[1216px] h-[177px]">
          <p
          ...
          <section className="absolute h-[33.9%] w-[24.67%] top-[0%] right-[75.33%] bottom-[66.1%] left-[0%]">
            <a
        ...
        <section className="absolute top-[220px] left-[calc(50%_-_675px)] w-[1350px] h-[400px]">
          <p
      ...
      >
        <button
          className="cursor-pointer [border:none] p-0 bg-[transparent]  text-5xl leading-[120%] font-semibold font-sans text-dark-green-color text-left inline-block"
          autoFocus={true}
